<template>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="field">
          <label class="label" v-if="selectedSearch !== null">Saved Search Id: {{selectedSearch.id}}</label>
        ...
        <div class="field">
          <div class="control">
            ...
            <button class="button is-success is-small" id="load-button" v-on:click="toggleSearchModal()">Load Saved Search</button>
            <button class="button is-success is-small" id="save-button" v-on:click="saveSearchTerms()">Save Search Terms</button>
    ...
    <div class="modal" id="saved-searches-modal">
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <article v-for="search in savedSearches" :id="search.id" class="message is-info">
 ...
 export default {
     ...
     methods: {
       ...
       saveNewSearch: function(item) {
         axios.post('/api/searches', item).then(response => {
       ...
       saveSearchTerms: function() {
         ...
         if(this.selectedSearch === null){
           id = prompt("Please enter an id for the search terms.");
       ...
       editSearch: function(item) {
         axios.put('/api/searches/' + item.id, item).then(response => {
           this.loadSearches();
         }).catch(err => {
           alert(err);
         });
